...
This could occur if the RSA Key length is small (512 bit) and we have received reports that regenerating the TLS Certificate using [new-certificate](/docs/installation/tentacle.exe-command-line/new-certificate.md) fixes the issue.
