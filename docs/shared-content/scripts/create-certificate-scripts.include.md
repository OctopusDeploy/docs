...
try
{
    ...
    # Submit request
    Invoke-RestMethod -Method Post -Uri "$octopusURL/api/$space/certificates" -Body ($jsonPayload | ConvertTo-Json -Depth 10) -Headers $header
}
catch
{
...
try
{
    ...
    repository.Certificates.Create(octopusCertificate);
}
catch (Exception ex)
{
