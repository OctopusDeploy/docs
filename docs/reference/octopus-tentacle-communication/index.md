...
We have built comprehensive troubleshooting guides for both [Listening Tentacles](/docs/infrastructure/windows-targets/listening-tentacles/troubleshoot-listening-tentacles.md) and [Polling Tentacles](/docs/how-to/troubleshoot-polling-tentacles.md).
