...
Octopus [variables](/docs/deploying-applications/deployment-process/variables/index.md) support substitution throughout: a variable may be bound to an expression that incorporates the values of other variables:
