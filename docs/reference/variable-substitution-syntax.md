...
Octopus [variables ](/docs/home/deploying-applications/variables.md)support substitution throughout: a variable may be bound to an expression that incorporates the values of other variables:
