...
If you need to move other folders than the Octopus Home folder, you can do that using the command-line as described below. Also see [moving octopus server folders](moving-octopus-server-folders#MovingOctopusServerfolders-MoveotherOctopusServerfolders)
