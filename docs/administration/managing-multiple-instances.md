...
Upgrades of Tentacles deployed on the same machine are all done at the same time, in other words, if you have mutiple Tentacles running on the same machine, when the upgrade is ran, all Tentacles will be upgraded. 
