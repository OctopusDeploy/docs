...
If Tentacles are running under different accounts, please ensure the [upgrade account](/docs/deployment-targets/environments/machine-policies.md#MachinePolicies-TentacleUpdateAccount) has enough rights to upgrade all Tentacles.
