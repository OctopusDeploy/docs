...
See the following documentation page for further information on configuring Octopus to use a [specific Active Directory contianer](/docs/administration/specifying-a-custom-container-to-use-for-ad-authentication).
