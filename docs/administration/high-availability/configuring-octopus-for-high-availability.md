...
For more information on this command please refer to the [Tentacle Poll Server options document](/docs/installation/tentacle.exe-command-line/poll-server.md)
