...
- Calculating deltas between packages for [delta compression](/docs/deployments/package-deployments/delta-compression-for-package-transfers.md) (I/O-bound and CPU-bound).
...
1. Consider how you transfer your packages: {#package-transfer}
    - If network bandwidth is the limiting factor, consider using [delta compression for package transfers](/docs/deployments/package-deployments/delta-compression-for-package-transfers.md).
...
1. Consider the size of your packages:
    ...
    - When using [delta compression for package transfers](/docs/deployments/package-deployments/delta-compression-for-package-transfers.md), larger packages require more CPU and disk IOPS on the Octopus Server to calculate deltas - this is a tradeoff you can determine through testing.
