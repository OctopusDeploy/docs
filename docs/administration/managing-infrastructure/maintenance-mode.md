...
- The task queue will still be processed:
  ...
  - Tasks which were already queued (including [scheduled deployments](/docs/release-management/index.md#scheduling-a-deployment)) will be started and run through to completion.
