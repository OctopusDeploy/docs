...
2. Toggle the [Drain](/docs/administration/high-availability/maintain/managing-high-availability-nodes.md#ManagingHighAvailabilityNodes-Drain) option for each Octopus Server node in {{ Configuration,Nodes }}
