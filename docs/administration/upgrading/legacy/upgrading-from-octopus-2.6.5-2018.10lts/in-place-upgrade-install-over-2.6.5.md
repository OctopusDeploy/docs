...
You can follow the instructions on this [page](/docs/administration/configuration/server-configuration-and-file-storage\index.md#ServerconfigurationandFilestorage-CleanUp) to clean up files left over from your **Octopus 2.6** to **Octopus 3.x** upgrade.
