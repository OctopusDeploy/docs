...
:::hint
View our [guide to installing an Octopus Deploy 2.0 server](/docs/home/installation/installing-octopus.md), which includes a video walkthrough.
:::
...
The Octopus 2.x migrator will not import permission settings from 1.6, due to changes made between the permission models. After you upgrade to 2.x, you will need to configure [Teams](/docs/home/administration/managing-users-and-teams.md) to assign permissions.
