...
4. Create a [new project](/docsprojects/index.md) with a single "Update Octopus Tentacle" step from the step template

 1. Ensure you choose or create a [Lifecycle](/docsprojects/lifecycles/index.md)that allows you to deploy to all Tentacles.
