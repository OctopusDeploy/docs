...
- Calculating deltas between packages for [delta compression](/docs/deploying-applications/deploying-packages/delta-compression-for-package-transfers.md) (I/O-bound and CPU-bound)
...
1. Consider how you transfer your packages: {#package-transfer}
    - If network bandwidth is the limiting factor, consider using [delta compression for package transfers](/docs/deploying-applications/deploying-packages/delta-compression-for-package-transfers.md).
