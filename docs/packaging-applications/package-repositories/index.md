...
Your Octopus server comes with a built-in repository which works out of the box without any extra configuration needed. It offers **better performance** for your deployments and the most **robust [retention policy](/docs/administration/retention-policies/index.md) support** for deployment packages.
