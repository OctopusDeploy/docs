...
:::info
Note: The `NuGet Feed` type discussed here is different from the [GitHub Feed](https://octopus.com/docs/packaging-applications/package-repositories/github-feeds) type.
:::
