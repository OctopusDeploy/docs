...
- ensure [delta compression for package transfers](/docs/deploying-applications/deployment-process/delta-compression-for-package-transfers.md) works as expected
