...
- Using the new **experimental** BitBucket Pipe called [octopus-cli](https://bitbucket.org/octopusdeploy/octopus-cli/src/master/README.md).

:::warning 
**Experimental Pipe:**

The `octopus-cli` Bitbucket Pipe is currently experimental.
...
To show how you can achieve the same pack and push commands as above, here's an example pipeline step, but this time using the `octopus-cli` Bitbucket Pipe.
...
:::success
**Example Bitbucket Pipeline with octopus-cli Pipe:**
...
- [Bitbucket Pipe for Octopus Deploy: octopus-cli](https://octopus.com/blog/octopus-bitbucket-pipe)
