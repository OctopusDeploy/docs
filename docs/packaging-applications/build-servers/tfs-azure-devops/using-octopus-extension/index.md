...
Enter a valid [Octopus API Key](/docs/octopus-rest-api/api/how-to-create-an-api-key.md) in the **API Key** field.
...
This step is only required if you are not [using OctoPack](/docs/octopus-rest-api/tfs-azure-devops\using-octopack.md) to create your package.
:::
