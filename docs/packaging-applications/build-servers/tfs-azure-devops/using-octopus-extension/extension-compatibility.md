...
When passing [build information](docs/packaging-applications/build-servers/index.md#build-information) to Octopus from TFS, you may encounter issues when trying to use the build link generated by the Octopus TFS extension.
