...
![](images/jenkins/global-tools-cli-configure.png "width=500")
...
The Octopus Jenkins plugin comes with these Octopus Build Steps:
 ...
 ![](images/jenkins/menu-options.png "width=500")
...
![](images/jenkins/push-build-information.png "width=500")
...
![](images/jenkins/create-release.png "width=500")
...
![](images/jenkins/deploy-release.png "width=500")

A successful run looks like this:

![](images/jenkins/random-quotes-successful-run.png "width=500")
