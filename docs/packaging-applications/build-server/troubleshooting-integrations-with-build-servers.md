...
The Octopus Deploy team supports many of the most popular integration plugins/extensions our there, like the ones for [Azure DevOps/TFS](\docs\api-and-integration\tfs-azure-devops\index.md), [Teamcity](\docs\api-and-integration\teamcity/index.md) and [Bamboo](\docs\api-and-integration\bamboo.md). All the steps provided by these extensions/plugins are nothing but wrappers of `Octo.exe` that provide a UI with fields whose values will be passed to this command line tool during the build.
