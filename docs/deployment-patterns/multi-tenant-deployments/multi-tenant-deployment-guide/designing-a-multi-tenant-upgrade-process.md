...
As a general rule, we don't recommend deploying to all tenants when there are hundreds of them. This may cause an unnecessary overload on your Octopus instance, and this is when we would recommend deploying using [Tenant Tags](/docs/deployment-patterns/multi-tenant-deployments/tenant-tags).
...
![](images/multi-tenant-pinned-tenant.png"width=500")
