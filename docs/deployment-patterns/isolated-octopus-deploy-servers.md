...
- Finally, to automate anything else that isn't possible above, the [REST API](/docs/octopus-rest-api/api/index.md) or [Octopus.Client](/docs/octopus-rest-api/octopus.client.md) can be used.
