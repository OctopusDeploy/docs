...
2. Use the **[Substitute Variables](/docs/deployment-process/substitute-variables-in-files.md) in Files feature** to replace any values specified by the `#{variable}` syntax in any text-based file.
