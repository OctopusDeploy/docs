...
3. Use the **[Configuration Transforms](/docs/home/deploying-applications/configuration-files.md) feature** to transform your XML configuration files for each environment or machine either based on conventions or explicitly.
