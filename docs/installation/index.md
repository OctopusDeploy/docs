...
This section includes information about hosting options for the Octopus Server Linux Container, and migration considerations when moving to the Octopus Server Linux Container From Windows Server or the *deprecated* Windows Container.

- [Octopus Server Linux Container](/docs/installation/octopus-server-linux-container/index.md)
- [Hosting the Octopus Server Linux Container](/docs/installation/octopus-server-linux-container/hosting/index.md)
