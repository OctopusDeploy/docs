...
We added first-class support for automatically [cleaning up environments](/docs/administration/octopus-tentacle-infrastructure/environments/elastic-and-transient-environments/cleaning-up-environments.md).
:::
