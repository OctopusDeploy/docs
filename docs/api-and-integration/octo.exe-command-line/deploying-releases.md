...
[Octo.exe](/docs/home/api-and-integration/octo.exe-command-line.md) can be used to deploy releases that have [already been created](/docs/home/api-and-integration/octo.exe-command-line/creating-releases.md).
