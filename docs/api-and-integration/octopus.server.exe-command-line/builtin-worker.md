...
Use the builtin-worker command to configure the user context that the [built-in worker](/docs/administration/workers#built-in-worker) runs under.  Available in `2018.1.0` and later.
