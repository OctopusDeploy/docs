...
Use the builtin-worker command to configure the user context that the [built-in worker](/docs/administration/managing-infrastructure/workers/index.md#built-in-worker) runs under.  Available in **Octopus 2018.1.0** and later.
