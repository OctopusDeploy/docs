...
Version 2.6 of Octopus Deploy introduced [Lifecycles ](/docs/deploying-applications/deployment-process/projects/lifecycles/index.md)and [Automatic Release Creation](/docs/deploying-applications/deployment-process/automatic-release-creation.md). You can use these two features to automatically deploy to one or more environments when a new package is pushed to the built-in NuGet repository.
