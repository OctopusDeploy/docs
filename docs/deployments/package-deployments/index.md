...
You can dynamically select a Package Feed and/or the Package ID at deployment time using an Octopus variable expression. Learn more about [using dynamically selecting packages at deployment time](/docs/deployments/package-deployments/dynamically-selecting-packages.md).
:::
...
Each part of a package step is [executed in a specific order](/docs/deployments/package-deployments/package-deployment-feature-ordering.md) by the open-source [Calamari project](https://github.com/OctopusDeploy/Calamari) to enable more complex deployment scenarios.
:::
