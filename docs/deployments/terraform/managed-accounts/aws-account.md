---
title: AWS accounts
description: Using Octopus managed AWS accounts with Terraform
---
...
![AWS Account Variable](/docs/deployments/terraform/managed-accounts/images/aws-account-variable.png "width=500")

The `Add Variable` window is then displayed and lists all the AWS accounts.

Select the account that was created in the previous step to assign it to the variable.

![AWS Account Variable Selection](/docs/deployments/terraform/managed-accounts/images/aws-account-variable-selection.png "width=500")
...
![AWS Account](/docs/deployments/terraform/managed-accounts/images/step-aws-account.png "width=500")

The supplied account can optionally be used to assume a different AWS service role. This can be used to run the AWS commands with a role that limits the services that can be affected.

![AWS Role](/docs/deployments/terraform/managed-accounts/images/step-aws-role.png "width=500")
