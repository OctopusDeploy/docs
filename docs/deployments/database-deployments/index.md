...
Learn more about [configuration settings](/docs/deployments/database-deployments/configuration/index.md).
...
If you are deploying to SQL Server, see the [SQL Server section](/docs/deployments/database-deployments/sql-server/index.md).
