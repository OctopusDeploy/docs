...
Learn more about [manual approvals](/docs/deployments/database-deployments/common-patterns/manual-approvals.md).
...
Learn more about [automatic approvals](/docs/deployments/database-deployments/common-patterns/automatic-approvals.md).
...
Learn more about [ad-hoc data change scripts](/docs/deployments/database-deployments/common-patterns/adhoc-data-changes.md)
...
We recommend rolling forward.  Learn more about [automatic backups and rollbacks](/docs/deployments/database-deployments/common-patterns/backups-rollbacks.md).
