...
The following example configures a [polling Tentacle](/docs/infrastructure/windows-targets/polling-tentacles.md), and registers it with an Octopus Deploy server:
