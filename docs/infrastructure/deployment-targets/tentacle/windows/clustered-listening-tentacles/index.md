...
![](images/shared-disk-properties.jpg "width=500")
...
![](images/configure-clusterhostname.jpg "width=500")
...
![](images/cluster-newrolewizard-servicetype.jpg "width=500")

Find and highlight the **OctopusDeploy Tentacle** service in the list of available services, then click **Next**.

![](images/cluster-newrolewizard-selectservice.jpg "width=500")
