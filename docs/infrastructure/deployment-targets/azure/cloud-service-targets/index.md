...
- You will firstly need an [Azure Management Certificate account](/docs/infrastructure/accounts/azure/index.md#azure-management-certificate) that references your Azure subscription.
...
![](create-azure-cloud-service-target.png)
