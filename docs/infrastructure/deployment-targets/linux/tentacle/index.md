...
Octopus supports HTTP proxies for communication from the Tentacle and Octopus Server. See the [proxy documentation](/docs/infrastructure/deployment-targets/windows-targets/proxy-support) for more information about proxies. To configure a proxy for polling communication:
