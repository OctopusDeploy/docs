...
- [Download the archive](https://download.octopusdeploy.com/linux-tentacle/tentacle-5.0.1-ci0010-linux_x64.tar.gz)
...
```bash Archive
wget https://download.octopusdeploy.com/linux-tentacle/tentacle-5.0.1-ci0010-linux_x64.tar.gz
#or
