...
:::warning
Linux Arm support is currently experimental.
:::

:::info
Requirements: 
 - Octopus Server 2020.5.0+
 - 32-bit Linux operating system on ARM hardware
:::
...
curl -L https://octopus.com/downloads/latest/Linux_ArmTarGz/OctopusTentacle --output tentacle-linux_arm.tar.gz

mkdir /opt/octopus
tar xvzf tentacle-linux_arm.tar.gz -C /opt/octopus
