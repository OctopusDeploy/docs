...
Note that [Substitute Variables in Files](/docs/deployment-process/substitute-variables-in-files.md) can still be used without issue on earlier Mono versions.
