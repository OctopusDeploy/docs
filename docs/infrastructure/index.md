...
After you've configured your environments, you can define a [lifecycle](/docs/infrastructure/lifecycles/index.md) that specifies how your software is promoted through your environments, and which projects are associated with which environments.
