...
:::warning
Ubuntu 18.04 is currently the `Ubuntu (default)` image. Ubuntu 18.04 images will be deprecated on 3 April 2023. Please refer to [planned transition to Ubuntu 22.04](https://www.example.com/TODO) for further details.
:::
