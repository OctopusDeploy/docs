...
To add this step to your runbook:
...
Optionally configure any [conditions](/docs/deployment-process/conditions/index.md) for the step, click **Save**, and you have a runbook to start an IIS Application Pool.
...
Click **Save**, and you have a runbook to stop an IIS Application Pool.
