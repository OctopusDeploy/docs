...
In the following example, we'll use the [MySQL - backup database](https://library.octopus.com/step-templates/4fa6d062-d4da-4a02-849e-dec804554453/actiontemplate-mysql-backup-database - Backup Database) community step template.
...
This will check if a database exisits and backup a database on the MySQL instance. 