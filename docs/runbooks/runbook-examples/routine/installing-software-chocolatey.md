...
With Operation Runbooks, you can create a runbook as part of a routine operations task to install software via Chocolatey that are required for your [deployment targets](/docs/getting-started/deployment-targets.md) or [Workers](/docs/getting-started/octopus-concepts/workers.md).
