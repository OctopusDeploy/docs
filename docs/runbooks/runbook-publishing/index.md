...
Runbooks and deployments define their processes in exactly the same way. However, where a deployment has a [release](/docs/getting-started/creae-a-release.md), a runbook has what is called a Snapshot. 
