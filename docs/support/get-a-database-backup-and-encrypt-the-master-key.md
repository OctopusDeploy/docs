...
![Backup SQL database in SQL Server Management Studio](images/sql_server_management_studio_backup_db.png "width=500")

2. Encrypt your Master Key.

:::hint
You can get your Master Key using [Octopus Manager](/docs/security/data-encryption.md#Securityandencryption-YourMasterKey) or by using the `show-master-key` command in [Octopus.Server.exe](/docs/installation/octopus.server.exe-command-line/show-master-key.md).
:::
