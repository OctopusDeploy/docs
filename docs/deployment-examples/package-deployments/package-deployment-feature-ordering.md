...
2. **PreDeploy.\* Scripts** - runs matching [scripts included in the package](/docs/deployment-examples/custom-scripts/index.md#Customscripts-ScriptsinPackages) or defined using the [Custom PowerShell Scripts](/docs/deployment-examples/custom-scripts/index.md#Customscripts-Scriptsinpackagesteps) feature.
...
10. **Deploy.\* Scripts**- runs matching [scripts included in the package](/docs/deployment-examples/custom-scripts/index.md#Customscripts-ScriptsinPackages) or defined using the [Custom PowerShell Scripts](/docs/deployment-examples/custom-scripts/index.md#Customscripts-Scriptsinpackagesteps) feature.
...
14. **PostDeploy.\* Scripts**- runs matching [scripts included in the package](/docs/deployment-examples/custom-scripts/index.md#Customscripts-ScriptsinPackages) or defined using the [Custom PowerShell Scripts](/docs/deployment-examples/custom-scripts/index.md#Customscripts-Scriptsinpackagesteps) feature.
