...
Learn more about [ad-hoc data change scripts](/docs/deployment-examples/database-deployments/common-patterns/adhoc-data-changes.md)
...
We recommend rolling forward.  Learn more about [automatic backups and rollbacks](/docs/deployment-examples/database-deployments/common-patterns/backups-rollbacks.md).
