...
![A sample ad-hoc script process](images/adhoc_scripts_process.png)
...
![The prompted variables for the ad-hoc script process](images/adhoc_scripts_submit.png)
...
![Ad hoc script requires approval](images/adhoc_approval_required.png)
...
![Task progress for the ad-hoc script](images/adhoc_auto_approval.png)
