...
![An image of the manual approval deployment process](images/manual_approval_deployment_process.png)
...
![An artifact in Octopus Deploy](images/manual_approval_artifacts.png)
...
![A deployment process with two manual interventions](images/manual_approval_two_manual_interventions.png)
...
![A deployment process with one manual intervention](images/manual_approval_one_manual_intervention.png)
...
![A deployment process with a delta report generated for production](images/manual_approval_generate_delta_report_for_production.png)
