...
If you already have a working Linux machine with Docker Engine installed you can use that once you have configured it as an [SSH Target](/docs/infrastructure/deployment-targets/linux/ssh-targets/index.md) in Octopus.
...
1. Install Ubuntu.
2. Configure your Ubuntu machine as an [SSH Target](/docs/infrastructure/deployment-targets/linux/ssh-targets/index.md) in Octopus - [this guide may be helpful](/docs/deployment-examples/node-on-linux-deployments/configuring-target-machine.md).
...
![](/docs/images/5670973/5865797.png "width=500")
