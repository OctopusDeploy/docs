...
:::hint
Refer to [this guide](/docs/infrastructure/azure/index.md) for more details, and the impact of choosing the right kind of Azure Account on the Azure SDK that will be available.
:::
