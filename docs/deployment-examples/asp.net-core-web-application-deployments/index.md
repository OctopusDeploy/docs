...
If you are using the [built-in repository](/docs/packaging-applications/package-repositories/built-in-repository/pushing-packages-to-the-built-in-repository.md) you can create a [zip file](/docs/packaging-applications/create-packages/octo.exe.md#create-zip-packages). 
