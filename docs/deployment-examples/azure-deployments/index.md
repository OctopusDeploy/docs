...
With [Operations Runbooks](/docs/operations-runbooks/index.md), Octopus provides built-in steps to help manage your infrastructure in Azure:
- [Resource Group Templates](/docs/operations-runbooks/runbook-examples/azure/resource-groups/index.md).
...
- [Azure runbook examples](/docs/operations-runbooks/runbook-examples/azure/index.md).
