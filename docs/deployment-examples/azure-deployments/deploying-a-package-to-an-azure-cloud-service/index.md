...
2. Environment-per-region: by creating an environment per region you can leverage [lifecycles](/docs/managing-releases/lifecycles/index.md) to create a strict release promotion process.
