...
1. Choose the type of Deployment Target you want to set up and follow these [instructions](/docs/infrastructure/deployment-targets/index.md#adding-deployment-targets) for your type of target.
