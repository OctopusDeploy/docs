...
This guide assumes some familiarity with Octopus Deploy.  You should be able to configure [projects ](/docs/deploying-applications/projects/index.md)and have a [Tentacle or SSH deployment target](/docs/deployment-targets/index.md) already configured.
