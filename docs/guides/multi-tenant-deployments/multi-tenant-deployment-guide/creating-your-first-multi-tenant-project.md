...
3. Create a new [lifecycle](/docs/deploying-applications/projects/lifecycles.md) called **MT Lifecycle** adding a single phase called **MT Production** deploying manually into the **MT Production** environment we created earlier.
