...
:::hint
Multi-tenant deployments are an advanced pattern, and this guide assumes you are already familiar with Octopus concepts like [projects](/docs/deploying-applications/projects/index.md), [environments](/docs/deployment-targets/environments/index.md), [lifecycles](/docs/deploying-applications/projects/lifecycles/index.md), [variables](/docs/deploying-applications/variables/index.md) and [deploying applications](/docs/deploying-applications/index.md).
:::
