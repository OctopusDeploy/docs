...
We often get asked how you can use Octopus to deploy your iOS/Android applications. While we do not currentlly have `Out Of Box` support for iOS/Android apps, we can provide some pointers and recomendations that we have heard from our customers. Generally, its most useful for deploying iOS apps to Apple/Google for review and deploying any supporting web services/databases/infrastructure at the same time. This co-ordination is the key value of using Octopus to version your releases and deploy your mobile app.
