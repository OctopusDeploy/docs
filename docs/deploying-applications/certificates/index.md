...
Certificates managed by Octopus can be configured as the [value of variables](/docs/deployment-process/variables/typed-variables.md#certificate-variables), and used from custom deployment scripts.
