...
- Which [Variables](/docs/deploying-applications/deployment-process/variables/index.md) to use: Variables can be scoped to channels.
...
Version rules assist in selecting the correct versions of packages for the Channel.  They are only used when creating a release, either manually or via [Automatic Release Creation](/docs/deploying-applications/deployment-process/steps/automatic-release-creation.md).
...
When enabling [Automatic Release Creation](/docs/deploying-applications/deployment-process/steps/automatic-release-creation.md) for your project, you are required to select a Channel (if the project has more than one).
