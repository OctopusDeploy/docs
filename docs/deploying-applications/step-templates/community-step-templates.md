...
- [Install and add a community step template directly from your project's deployment process](/docs/deploying-applications#Addingsteps-Addingacommunitycontributedsteptemplates)
