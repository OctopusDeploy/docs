...
| --- | --- | --- |
| Octopus.Deployment.Tenant.Tags | *Tenant type/External, Upgrade ring/Early adopter* | 
...
| Name | Example | Description |
| --- | --- | --- |
| Octopus.Web.BaseUrl | *[https://my-octopus](https://my-octopus)* | 

The default URL at which the server can be accessed This variable has been deprecated as of Octopus 2.0
 |
| --- | --- | --- |
...
If specified, your PowerShell scripts will be invoked using `PowerShell.exe -version {Version}` where {Version} is the value you specified. Accepted values are *2.0*, *3.0*, *4.0, 5.0* ***Introduced in Calamari version 3.3.13 which was released with Octopus Deploy version 3.3.13.***
 |
