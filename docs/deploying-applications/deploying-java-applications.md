...
This guide assumes some familiarity with Octopus Deploy.  You should be able to configure [projects ](/docsprojects/index.md)and have a [Tentacle or SSH deployment target](/docs/infrastructure/index.md) already configured.
