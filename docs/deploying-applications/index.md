...
Now that you've [installed Octopus and Tentacle](/docs/installation.md), and you've created your [environments](/docs/key-concepts/environments.md) and a [project](/docs/key-concepts/projects.md), and your applications have been [packaged for deployment](/docs/packaging-applications.md), it's time to look at deploying applications with Octopus Deploy.
...
Steps can also have conditions. You can restrict a step so that it only runs when deploying to specific [environments](/docs/key-concepts/environments.md) (e.g., an Email step that only runs on production deployments).
...
- [Deploying packages](/docs/deploying-applications/deploying-packages.md)
...
- [Variables](/docs/deploying-applications/variables.md)
...
- [Deploying to Azure](/docs/deploying-applications/deploying-to-azure.md)
 - [Deploying a package to an Azure Cloud Service](/docs/deploying-applications/deploying-to-azure/deploying-a-package-to-an-azure-cloud-service.md)
 ...
 - [Deploying a package to an Azure Web App](/docs/deploying-applications/deploying-to-azure/deploying-a-package-to-an-azure-web-app.md)
...
- [Docker Containers](/docs/deploying-applications/docker-containers.md)
...
- [Azure deployments](/docs/guides/azure-deployments.md)
 - [Cloud Services](/docs/guides/azure-deployments/cloud-services.md)
  ...
  - [Cloud Service concepts](/docs/guides/azure-deployments/cloud-services/cloud-service-concepts.md)
 ...
 - [Creating an Azure Account](/docs/guides/azure-deployments/creating-an-azure-account.md)
 ...
 - [Resource Groups](/docs/guides/azure-deployments/resource-groups.md)
 ...
 - [Running Azure PowerShell](/docs/guides/azure-deployments/running-azure-powershell.md)
 ...
 - [Web Apps](/docs/guides/azure-deployments/web-apps.md)
  - [Getting started with Azure Web Apps](/docs/guides/azure-deployments/web-apps/getting-started-with-azure-web-apps.md)
  - [Web App concepts](/docs/guides/azure-deployments/web-apps/web-app-concepts.md)
   ...
   - [Web App deployment step](/docs/guides/azure-deployments/web-apps/web-app-concepts/web-app-deployment-step.md)
...
- [Deploying ASP.NET Core Web Applications](/docs/guides/deploying-asp.net-core-web-applications.md)
...
- [Multi-tenant deployments](/docs/guides/multi-tenant-deployments.md)
...
- [Node on \*Nix deployments](/docs/guides/node-on-nix-deployments.md)
...
- [User Role & Teams Configurations](/docs/guides/user-role-&-teams-configurations.md)
...
- [Use the Team Foundation Build Custom Task](/docs/guides/use-the-team-foundation-build-custom-task.md)
...
- [Elastic and Transient Environments](/docs/guides/elastic-and-transient-environments.md)
...
- [Server Extensibility](/docs/guides/server-extensibility.md)
 ...
 - [Building an Authentication Provider](/docs/guides/server-extensibility/building-an-authentication-provider.md)
...
- [Octopus HA](/docs/guides/octopus-ha.md)
 - [Load balancers](/docs/guides/octopus-ha/load-balancers.md)
...
- [Coordinating Multiple Projects](/docs/guides/coordinating-multiple-projects.md)
