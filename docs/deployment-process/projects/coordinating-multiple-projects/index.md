...
**Octopus 3.5** introduced [subscriptions](/docs/administration/configuration/subscriptions/index.md), which can call a web service or send an email when Octopus events occur.
