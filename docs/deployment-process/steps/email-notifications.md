...
- Use email in conjuction with [manual approvals](/docssteps/manual-intervention-and-approvals.md) to make sure everyone is ready for a new deployment
...
Email can be chosen as the step type when you click **Add Step** in your project's **Process** tab. For information about adding a step to the deployment process, see the [add step](/docssteps/index.md) section.
...
- Send an email based on the value of a variable expression which works really well with [output variables](/docsvariables/output-variables.md)
...
See [System variables](/docsvariables/system-variables.md)
:::
