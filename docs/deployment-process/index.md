...
1. Create a [project](docsprojects/index.md).
1. Add [steps](docssteps/index.md) to the project.
1. Add [configuration variables](docsvariables/index.md) to the project.
1. Create a [release](docsreleases/index.md).
