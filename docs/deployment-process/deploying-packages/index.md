...
1. [Output variables](/docsvariables/output-variables.md) and deployment [artifacts](/docsartifacts.md) from this step are sent back to the Octopus Server
...
When adding a step to your deployment process, choose the **Deploy a Package** option. For more information, see the [add step](/docssteps/index.md) section.
...
You can dynamically select a Package Feed and/or the Package ID at deployment time using an Octopus variable expression. Learn more about [using dynamically selecting packages at deployment time](/docsdeploying-packages/dynamically-selecting-packages.md).
:::
...
- [Configuration files](/docsconfiguration-files/index.md)
