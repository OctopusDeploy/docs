...
|**`Octopus.Deployment.Machines.Names`** <br/>Names of machines being targeted by the deployment. ***Introduced in Octopus Deploy version 2018.2.x*** | WEBSRV01,APPSRV01|
