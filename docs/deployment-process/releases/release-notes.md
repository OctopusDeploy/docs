...
Release notes are also rolled up into the [deployment notes](/docs/deployment-process/releases/deployment-notes.md).
...
The following are examples of using release notes templates with package [build information](/docs/packaging-applications/build-servers/index.md#build-information) and [issues](/docs/deployment-process/issue-tracking/index.md).
