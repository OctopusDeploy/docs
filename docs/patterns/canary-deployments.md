...
2. Have a [manual intervention](/docs/deploying-applications/deployment-process/steps/manual-intervention-and-approvals.md) step to wait until we are satisfied
