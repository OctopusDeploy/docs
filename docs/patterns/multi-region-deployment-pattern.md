...
5. Use [Scheduled Deployments](/docs/deploying-applications/deployment-process/scheduled-deployments.md) to plan deployments for times of low usage
...
6. Use [Scheduled Deployments](/docs/deploying-applications/deployment-process/scheduled-deployments.md) to plan deployments for times of low usage
