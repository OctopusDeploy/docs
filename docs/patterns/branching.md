...
In Octopus 3.2 we implemented [Channels](/docs/deploying-applications/deployment-process//channels.md) as a way to support deployments using some of the source code branching strategies discussed here. We've produced a [comprehensive walkthrough of Channels](https://octopus.com/blog/channels-walkthrough) that covers most of these strategies in detail.
:::
