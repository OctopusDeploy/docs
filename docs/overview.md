...
<p>
    You can install your own [self-hosted](/docs/installation/index.md) instance of the Octopus Deploy Server:
...
<p>
    Or you can use [Octopus Cloud](/docs/octopus-cloud/index.md).
