...
- Only run the step when deploying a release through a specific [channel](/docs/releases/channels/index.md).
...
With your deployment configured you're ready to create a [release](/docs/releases/index.md).