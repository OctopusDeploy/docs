...
- <a href="https://samples.octopus.app/app#/Spaces-682/projects/Projects-1341/deployments/process" target="_blank">Car Rental</a>: <i>A sample car rental application using PHP, Linux, and MySQL. [Build definition](https://jenkins.octopussamples.com/job/CarRental/)</i>
