...
The data migration tool also includes [import functionality](/docs/administration/octopus.migrator.exe-command-line/import).  First, copy all the project folders from the main instance to the test instance.  Then run this command for each project:
