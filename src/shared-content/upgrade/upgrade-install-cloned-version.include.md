...
:::figure
![Selecting the pre-existing database in the Octopus Manager wizard](/docs/img/shared-content/upgrade/images/select-existing-database.png)
:::

Selecting an existing database will ask you to enter the Master Key.

:::figure
![The prompt to enter the Master Key for an existing database](/docs/img/shared-content/upgrade/images/enter-master-key.png)
:::
