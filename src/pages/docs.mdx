...
Octopus can be used to deploy just about anything, anywhere. Whether it’s **Kubernetes**, **Linux** or **Windows** virtual machines, **AWS**, **Azure**, or **GCP**, so long as Octopus can speak to it via our advanced **Tentacle agent**, SSH, command line, or a web service, Octopus can handle it. 
...
- **Email our support** (we typically respond un under 1 hour)
