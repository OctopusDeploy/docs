...
:::figure
![Octopus Deploy Tenant variable dashboard](/docs/getting-started/tenant-variables.png "width=500")
:::
...
:::figure
![Octopus Deploy screen to edit a Tenant variable](/docs/projects/variables/images/tenant-variables-edit.png "width=500")
:::
...
:::figure
![Octopus Deploy Library variable sets screen](/docs/getting-started/library-variable-sets.png "width=500")
:::
...
:::figure
![Octopus Deploy Common Variables screen](/docs/projects/variables/images/variable-templates-project-template.png "width=500")
:::
...
| Version | Change | 
| ------------------ | ------------ | 
| 2024.1 | Added support for new thing | 
| 2023.2 | Deprecated unsupported thing | 
