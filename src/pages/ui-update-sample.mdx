...
:::figure
![Octopus Deploy Tenant variable dashboard](/docs/img/getting-started/tenant-variables.png)
:::
...
:::figure
![Octopus Deploy screen to edit a Tenant variable](/docs/img/projects/variables/images/tenant-variables-edit.png)
:::
...
:::figure
![Octopus Deploy Variable Sets screen](/docs/img/getting-started/library-variable-sets.png)
:::
...
:::figure
![Octopus Deploy Common Variables screen](/docs/img/projects/variables/images/variable-templates-project-template.png)
:::
