...
If you're using an Artifactory Generic Repository, you can create a feed in Octopus and use artifacts as part of your deployments. To create a feed go to **Deploy ➜ Manage ➜ External Feeds**. Select the **Add feed** button and selecting the *Artifactory Generic Repository* feed type.
...
:::figure
![Creating an Artifactory generic feed in Octopus](/docs/img/packaging-applications/package-repositories/images/artifactory-generic-feed-creation.png)
:::
...
To find the *Artifact Path Pattern* go to **Administration ➜ Layouts ➜ Regular Expression View ➜ Resolve** and copy the Artifact Path Regex expression. A new repository will use the default `simple-layout` generated by Artifactory, the regex for this layout is <code>(?<orgPath>.+?)/(?<module>[^/]+)/(?<module>\2)-(?<baseRev>[^/]+?)\.(?<ext>(?:(?!\d))[^\-/]+|7z)</code>.
...
:::
:::figure
![A custom repository layout in Artifactory](/docs/img/packaging-applications/package-repositories/images/artifactory-generic-feeds-custom-layout.png)
:::
...
:::figure
![Package information shown on an artifact in the Artifactory UI](/docs/img/packaging-applications/package-repositories/images/artifactory-generic-feed-package-information.png)
:::
...
:::figure
![Testing an Artifactory generic feed by searching for a package](/docs/img/packaging-applications/package-repositories/images/artifactory-generic-feed-test.png)
:::
...
:::figure
![An Artifactory artifact path pattern](/docs/img/packaging-applications/package-repositories/images/artifactory-generic-feed-path-pattern.png)
:::
...
:::figure
![A repository file layout where the module matches the package name](/docs/img/packaging-applications/package-repositories/images/artifactory-generic-feed-file-layout1.png)
:::

- The filename must also match the module:

:::figure
![A repository file layout where the filename matches the module](/docs/img/packaging-applications/package-repositories/images/artifactory-generic-feed-file-layout2.png)
:::

As mentioned previously in this documentation the file has to have a dependency declaration for it to show in Octopus:

:::figure
![The dependency declaration on an Artifactory artifact](/docs/img/packaging-applications/package-repositories/images/artifactory-generic-feed-package-information.png)
:::
...
:::figure
![Searching for the package in Octopus](/docs/img/packaging-applications/package-repositories/images/artifactory-generic-feed-package-search-example.png)
:::
