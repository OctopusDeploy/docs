...
:::figure
![The Container Registry link under Services in the OCI console](/docs/img/packaging-applications/package-repositories/guides/container-registries/images/oracle-cloud-infrastructure-container-registry-search.png)
:::

Click on **Create repository**

:::figure
![The Create repository button in the OCI Container Registry](/docs/img/packaging-applications/package-repositories/guides/container-registries/images/oracle-cloud-infrastructure-create-registry.png)
:::
...
:::figure
![The region of the newly created OCI repository](/docs/img/packaging-applications/package-repositories/guides/container-registries/images/oracle-cloud-infrastructure-region.png)
:::
