...
The plugin is simply a wrapper for the [Octopus CLI](/docs/cli/octopus-cli), the Octopus command line tool for creating and deploying releases.
...
![A branch specification on the TeamCity VCS configuration](/docs/img/packaging-applications/build-servers/images/teamcity-branch-specification.png)
