...
This is a good time to install the [Octopus CLI](/docs/cli/octopus-cli).

 The [OctopusDeploy Plugin](https://plugins.jenkins.io/octopusdeploy/) is a wrapper for the [Octopus CLI](/docs/cli/octopus-cli), the Octopus command line tool for creating and deploying releases, such as `/home/your-user-name/.dotnet/tools/dotnet-octo`.

You can do either of these:

  - Use the `dotnet tool install` command to install it, the [Octopus CLI Global Tool](/docs/cli/octopus-cli/install-global-tool) this works great on Linux and Windows.
...
:::figure
![Telling the Jenkins plugin where the Octopus CLI is installed](/docs/img/packaging-applications/build-servers/jenkins/images/global-tools-cli-configure.png)
:::
...
:::figure
![The Octopus Deploy servers section of the Jenkins configuration](/docs/img/packaging-applications/build-servers/jenkins/images/octopusdeploy-servers.png)
:::
...
The Octopus Jenkins plugin comes with these Octopus Build Steps:
 ...
 ![The Octopus Deploy actions available in Jenkins](/docs/img/packaging-applications/build-servers/jenkins/images/menu-options.png)
...
You can configure your Jenkins project to [package](/docs/cli/octopus-cli/pack) your application or other files on disk, without the need of any specification files, e.g. `.nuspec`.

The two supported formats are `zip` and `nuget`.

To see the full set of additional arguments that can be supplied see the [pack documentation](/docs/cli/octopus-cli/pack)

[Pack syntax for Pipeline](/docs/packaging-applications/build-servers/jenkins/pipeline/#pack)

:::figure
![The Package Application action in Jenkins](/docs/img/packaging-applications/build-servers/jenkins/images/package-application.png)
:::
...
:::figure
![The Push Packages action in Jenkins](/docs/img/packaging-applications/build-servers/jenkins/images/push-packages.png)
:::
...
:::figure
![The Push Build Information action in Jenkins](/docs/img/packaging-applications/build-servers/jenkins/images/push-build-information.png)
:::
...
Learn more about the [Octopus CLI](/docs/cli/octopus-cli) and the arguments it accepts.
:::
...
:::figure
![The Create Release action in Jenkins](/docs/img/packaging-applications/build-servers/jenkins/images/create-release.png)
:::
...
:::figure
![The Deploy Release action in Jenkins](/docs/img/packaging-applications/build-servers/jenkins/images/deploy-release.png)
:::
...
:::figure
![A successful Jenkins run for the Random Quotes project](/docs/img/packaging-applications/build-servers/jenkins/images/random-quotes-successful-run.png)
:::
