...
:::figure
![The original Kubernetes deployment process](/docs/img/deployments/patterns/rollbacks/kubernetes/octopus-original-deployment-process.png)
:::
...
:::figure
![The simple Kubernetes rollback process](/docs/img/deployments/patterns/rollbacks/kubernetes/octopus-simple-rollback-process.png)
:::
...
:::figure
![The complex Kubernetes rollback process](/docs/img/deployments/patterns/rollbacks/kubernetes/octopus-complex-rollback-process.png)
:::
...
:::figure
![A Kubernetes deployment annotation recording the Octopus release number](/docs/img/deployments/patterns/rollbacks/kubernetes/octopus-k8s-deployment-annotation.png)
:::
