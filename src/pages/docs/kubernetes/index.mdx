...
import kustomizeIcon from 'src/assets/icons/kustomize.svg';
import octopusIcon from 'src/assets/icons/octopus.svg';
import yamlIcon from 'src/assets/icons/yaml.svg';
