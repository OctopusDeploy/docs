...
import Kustomize from 'src/components/icons/Kustomize.astro';
import Octopus from 'src/components/icons/Octopus.astro';
import Yaml from 'src/components/icons/Yaml.astro';
