...
- Monitor and safely troubleshoot your Kubernetes application without needing to leave Octopus.
...
- Learn how to implement GitOps best practices with Octopus and use our observability features like [live status](/docs/kubernetes/live-object-status).
