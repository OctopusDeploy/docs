...
approval check. This variable can also be [scoped](/docs/projects/variables/index.md#scoping-variables) or configured as a [Prompted variable](/docs/projects/variables/prompted-variables/).
...
![JSM Integration Environment settings](images/jsm-environment-settings.png "width=500")
