...
| registration.argocd.webUiUrl           | string | Optional (default: null)  | The URL of your Argo CD instance's Web UI, used for generating deeplinks within Octopus Deploy                                                                  |   
...
| gateway.octopus.plainText              | string | Optional (default: false) | True if Octopus' grpc endpoint is using un-encrupted connections, false otherwise.                                                                              |
...
Hoever, it can also be scripted, using a command similar to the following:
```
