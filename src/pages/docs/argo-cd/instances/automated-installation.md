...
| gateway.argocd.serverGrpcUrl           | string | Required                  | The URL on which your Argo CD instance is listening for connections - the cluster _internal_ url - ie. <service-name>.<namespace>.svc.cluster.local:<port>      |
