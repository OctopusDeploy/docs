...
You must set a [maintenance window](/docs/octopus-cloud/maintenance-window) where you expect minimal to no usage of your Octopus Deploy instance. This maintenance window is when we perform background maintenance tasks on your instance.  
