...
In order to keep your instance of Octopus Cloud updated and running the latest version, we will occasionally need to take it offline to update the software. You can let us know the best time for this to do this by setting the maintenance window.

1. Log in to your Octopus account.
1. Select your cloud instance.
1. Click Configuration.
1. Scroll down to Maintenance Window.
1. Select the time in UTC, providing a window of at least two hours and click **Save maintenance window**.
