...
To keep your instance of Octopus Cloud updated and running the latest version, we occasionally need to take it offline to update the software. You can let us know the best time to do this by setting the maintenance window.
