...
For the purposes of this document, we will use `Z:\` as the drive letter.  Note: Use of a drive letter is for demonstration purposes, Azure Files supports UNC as well.
