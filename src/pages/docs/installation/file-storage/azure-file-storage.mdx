...
For disaster recovery scenarios, [we recommend leveraging a hot/cold configuration](https://octopus.com/whitepapers/best-practice-for-self-hosted-octopus-deploy-ha-dr). To achieve this with Azure you have several options available. Further details on the [redundancy options available for Azure Storage](https://learn.microsoft.com/en-us/azure/storage/common/storage-redundancy) can be found in the Microsoft documentation.
