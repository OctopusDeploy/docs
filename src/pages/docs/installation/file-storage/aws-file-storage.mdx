...
## Elastic Block Store (EBS)
AWS EBS is limited in that it can be attached to only one EC2 or container instance and is not an option for High Availiblity.
