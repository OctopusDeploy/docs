...
pubDate: 2023-01-01
modDate: 2025-05-19
title: Migrate from Windows Server to Linux Container
description: Move Octopus Server from a Windows Server installation to the Linux container image. Follow the step-by-step migration guide to transfer your data and config.
navOrder: 10
---
