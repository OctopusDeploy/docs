...
pubDate: 2023-01-01
modDate: 2025-05-19
title: Migrate Octopus Windows Container to Linux
description: Move Octopus Server from the Windows container image to the Linux container. Follow the migration guide to transfer your database backup and configuration.
navOrder: 20
---
