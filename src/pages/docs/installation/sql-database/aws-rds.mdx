...
pubDate: 2023-01-01
modDate: 2024-05-22
title: AWS RDS for the Octopus Deploy database
description: Host your Octopus Deploy database on AWS RDS. Review supported SQL Server editions, instance sizing, and configuration requirements before you get set up.
navOrder: 20
