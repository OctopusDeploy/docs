...
pubDate: 2023-01-01
modDate: 2024-05-22
title: GCP Cloud SQL for the Octopus Deploy database
description: Host your Octopus Deploy database on Google Cloud SQL. Review supported SQL Server editions, instance requirements, and configuration steps to get started.
navOrder: 40
