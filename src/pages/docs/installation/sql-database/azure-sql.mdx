...
pubDate: 2023-01-01
modDate: 2024-05-22
title: Azure SQL for the Octopus Deploy database
navTitle: Azure SQL
description: Host your Octopus Deploy database on Azure SQL. Review supported service tiers, sizing recommendations, and configuration steps before you get started.
navOrder: 30
