...
:::figure
![Three Tentacle targets in the Production environment](/docs/img/tenants/guides/tenants-sharing-machine-targets/target-list.png)
:::
...
:::figure
![A Hosting Group tag chosen in the Associated Tenants section of a target](/docs/img/tenants/guides/tenants-sharing-machine-targets/target-details.png)
:::
