...
:::figure
![The dashboard for a Team Avengers developer, showing only their tenant and environment](/docs/img/tenants/guides/multi-tenant-teams/images/team-avengers-dashboard.png)
:::
...
:::figure
![Deploying to Development with the OctoPetShop-Team-Avengers tenant automatically selected](/docs/img/tenants/guides/multi-tenant-teams/images/team-avengers-deploy.png)
:::
...
:::figure
![The Deploy button disabled when attempting to deploy to the Test environment](/docs/img/tenants/guides/multi-tenant-teams/images/team-avengers-deploy-to-test.png)
:::
