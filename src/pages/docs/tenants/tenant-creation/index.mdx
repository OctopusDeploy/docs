...
:::div{.hint}
It's also possible to create a tenant using the [Octopus REST API](/docs/octopus-rest-api/). Learn more in our [create a tenant](/docs/api/examples/tenants/create-tenant) example.
:::
