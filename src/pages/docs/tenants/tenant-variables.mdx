...
:::hint
Scoped project variables will be available for early access from Octopus version 2025.2. Please contact michelle.obrien@octopus.com if you would like to turn this feature on.

To assign an environment scope to your project variable, use the **Tenant Variables** section of the project's page, or the **Tenant Variables** section of the tenant's page. 
...
:::hint
Scoped common variables will be available for early access from Octopus version 2025.2. Please contact michelle.obrien@octopus.com if you would like to turn this feature on.
