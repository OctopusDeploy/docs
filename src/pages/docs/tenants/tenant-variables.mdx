...
:::hint
Scoped common variables will be available for early access from Octopus version 2025.1 with general availability from 2025.2. Please contact michelle.obrien@octopus.com if you would like to turn this feature on.
