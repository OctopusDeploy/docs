...
:::figure
![Project templates scoped to environments on the tenant variables screen](/docs/img/tenants/images/project-template-screen.png)
:::
...
:::figure
![Editing a project template's variable type and default value](/docs/img/tenants/images/project-template-edit.png)
:::

You can view and edit values for project's tenants and environments on a single screen.

:::figure
![Editing project template values for every tenant and environment on one screen](/docs/img/tenants/images/project-template-screen-edit.png)
:::

You can also set values for these variables on the tenant variables screen.

:::figure
![Setting a project template value on the tenant variables screen](/docs/img/tenants/images/project-template-tenant-value.png)
:::
...
:::figure
![A project template variable used in a deployment step](/docs/img/tenants/images/project-template-variable-value-in-step.png)
:::
...
:::figure
![A variable template defined on a library variable set](/docs/img/tenants/images/common-variable-template.png)
:::
...
:::figure
![Common variable values supplied at the tenant level](/docs/img/tenants/images/common-variable-tenant-value.png)
:::
...
:::figure
![The error shown when you lack permission to edit common variables](/docs/img/tenants/images/common-variable-permissions-error.png)
:::

## Snapshots \{#tenant-variables-and-snapshots}

When you [create a release](/docs/cli/octopus-cli/create-release/) in Octopus we take a snapshot of the deployment process and the current state of the [project variables](/docs/projects/variables).
