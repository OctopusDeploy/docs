...
:::hint
Scoped common variables will be available for early access from Octopus Cloud version 2025.1 and available to on-premises customers from release v2025.2. Please contact michelle.obrien@octopus.com if you would like to turn this feature on.
