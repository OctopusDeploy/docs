...
:::figure
![The SaaS model, with the same software deployed to multiple customers](/docs/img/tenants/images/saas-tenants.png)
:::
...
:::figure
![The regional model, with each geographic region treated as a tenant](/docs/img/tenants/images/region-tenants.png)
:::
...
:::figure
![The team model, with each development team treated as a tenant](/docs/img/tenants/images/team-tenants.png)
:::
