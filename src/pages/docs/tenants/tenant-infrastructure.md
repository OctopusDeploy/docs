...
:::figure
![The Deployment Targets page in the main navigation](/docs/img/tenants/images/octopus-deployment-targets.png)
:::
...
:::figure
![The Tenanted Deployments restriction options for a deployment target](/docs/img/tenants/images/target-restrictions-tenant-deployments.png)
:::
...
:::figure
![The Associated Tenants section of a deployment target](/docs/img/tenants/images/target-restrictions-associated-tenants.png)
:::
...
:::figure
![A deployment target configured as a dedicated host for a single tenant](/docs/img/tenants/images/multi-tenant-dedicated-deployment-target.png)
:::
...
:::figure
![A deployment using only the tenant's dedicated deployment targets](/docs/img/tenants/images/multi-tenant-deployment-dedicated.png)
:::
...
:::figure
![A green Shared-Farm-1 tag in a tenant tag set](/docs/img/tenants/images/multi-tenant-shared-tag.png)
:::
...
:::figure
![A deployment target filtered to the Shared-Farm-1 tag](/docs/img/tenants/images/multi-tenant-infra.png)
:::
...
:::figure
![Tenants tagged with Shared-Farm-1](/docs/img/tenants/images/multi-tenant-shared-server.png)
:::
