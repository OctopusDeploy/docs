...
2. Ensure the project uses at least one [lifecycle](/docs/releases/lifecycles/index/) which includes the environment(s) you want to connect the tenant to. You can connect a tenant to any environment included in any of the project's lifecycles. Each [channel](/docs/releases/channels/) can specify a different lifecycle.
