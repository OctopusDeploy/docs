...
Two sets of variables will be printed, first, the raw definitions before any substitutions have been performed, then the result of evaluating all variables for deployment.
   ...
   ![Variable definitions printed in the deployment log](/docs/img/support/images/variables.png)

1. **Create a new release** of your project for the variables to take effect.
2. Deploy the new release.
3. Open the deployment/task details, and go to the **Task log** tab. Click on the **Raw** link. You can also select the **Download** option if you want to look at this locally. You can download this and attach the log file to your support query.

   ![The Raw link on the Task log tab](/docs/img/support/images/rawlogs.png)

4. If you wish to troubleshoot this locally the raw log text file containing the entire deployment log will load in Octopus.

   ![The raw task log text file](/docs/img/support/images/raw.png)
