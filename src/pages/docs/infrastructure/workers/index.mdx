...
import ConfigureK8sAgentWorker from 'src/shared-content/tentacle/configure-k8s-agent-worker.include.md';
...
- A [Kubernetes Worker](/docs/infrastructure/workers/autoscaling-workers) that has been installed in a k8s cluster, and has self-registered with the Octopus Server
...
- [Registering a Kubernetes Agent as a Worker](#registering-a-kubernetes-agent-as-a-worker)
...
### Registering a Kubernetes Agent as a Worker

<ConfigureK8sAgentWorker />
