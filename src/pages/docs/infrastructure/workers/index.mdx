...
- A [Kubernetes Worker](/docs/infrastructure/workers/autoscaling-workers) that has been installed in a Kubernetes cluster, and has self-registered with the Octopus Server
