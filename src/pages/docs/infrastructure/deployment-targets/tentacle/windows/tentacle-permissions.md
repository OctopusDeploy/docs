...
Please be aware that to perform automatic Tentacle updates you need an account with [extra permissions](/docs/infrastructure/deployment-targets/machine-policies/#MachinePolicies-TentacleUpdateAccount).
