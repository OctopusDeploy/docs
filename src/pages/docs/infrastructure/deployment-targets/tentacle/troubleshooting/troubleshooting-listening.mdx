...
:::figure
![The page served by a healthy listening Tentacle](/docs/img/infrastructure/deployment-targets/tentacle/images/3278074.png)
:::
...
:::figure
![The Check for publisher's certificate revocation option in Internet Options](/docs/img/infrastructure/deployment-targets/tentacle/images/3278077.png)
:::
