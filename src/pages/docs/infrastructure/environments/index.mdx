...
- Scope variables to environment tags.

To use tags with environments, you need to create tag sets with the **Environment** scope. Tags are referenced using their canonical name format: `TagSetName/TagName`. For FreeText tag sets, you can use any value, such as `Region/us-west-2`.
