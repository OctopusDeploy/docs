...
:::div{.warning}
From Octopus Cloud version **2025.4.3897** we support tagging environments. This functionality is behind the `Extended Tag Sets` feature toggle, to request this functionality early, please contact [support](https://octopus.com/support).
:::
