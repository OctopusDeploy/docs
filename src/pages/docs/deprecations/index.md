...
Support for the Windows Tentacle Docker container is discontinued. The last version to support it is `12.0.4440`. A Linux Tentacle Docker container remains available.
