...
:::figure
![A bulk deployment creation server task listing each requested deployment](/docs/img/deployments/bulk-deployment-creation.png)
:::
...
:::figure
![The Re-run button on a bulk deployment server task with failed deployments](/docs/img/deployments/bulk-deployment-creation-retry.png)
:::
