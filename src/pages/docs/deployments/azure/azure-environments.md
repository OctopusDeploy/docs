...
![Azure Germany cloud details](images/de.png "width=500")
...
![Service Principal fields](images/sp.png "width=500")

And Management Certificate accounts as below:

![Management Certificate fields](images/mc.png "width=500")
