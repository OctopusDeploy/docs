...
1.  Go to your **[Deployment Process](/docs/deployments/index.md)** and click **Include.**
...
2.  Add a **[Script step](/docs/deployments/custom-scripts/index.md)**, ensure you choose PowerShell and call the *Say-Hello* function from it.
