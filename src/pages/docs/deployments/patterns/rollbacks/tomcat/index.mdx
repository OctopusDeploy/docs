...
:::figure
![The original Tomcat deployment process](/docs/img/deployments/patterns/rollbacks/tomcat/octopus-original-deployment-process.png)
:::
...
:::figure
![The simple Tomcat rollback process](/docs/img/deployments/patterns/rollbacks/tomcat/octopus-simple-rollback-process.png)
:::
...
:::figure
![Step notes describing the conditions under which each step runs](/docs/img/deployments/patterns/rollbacks/tomcat/octopus-step-notes.png)
:::
...
:::figure
![The complex Tomcat rollback process](/docs/img/deployments/patterns/rollbacks/tomcat/octopus-complex-rollback-process.png)
:::
...
:::figure
![The Stop the application option on the Tomcat step](/docs/img/deployments/patterns/rollbacks/tomcat/octopus-stop-application.png)
:::
...
:::figure
![The Advanced Options section setting the Tomcat deployment version](/docs/img/deployments/patterns/rollbacks/tomcat/octopus-tomcat-advanced.png)
:::
...
:::figure
![The run condition on the Deploy to Tomcat step](/docs/img/deployments/patterns/rollbacks/tomcat/octopus-deploy-tomcat-run-condition.png)
:::
