...
Learn about [custom scripts](/docs/deployments/custom-scripts/index.md) and [executing custom scripts in packages](/docs/deployments/custom-scripts/scripts-in-packages/).
