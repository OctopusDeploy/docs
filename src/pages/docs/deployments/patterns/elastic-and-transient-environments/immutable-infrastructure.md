...
:::figure
![An infrastructure project provisioning Tentacles for an application project](/docs/img/deployments/patterns/elastic-and-transient-environments/images/5865664.png)
:::
...
6. Add a step that performs a health check, excluding unavailable machines from the deployment:
   ...
   ![A health check step that excludes unavailable machines](/docs/img/deployments/patterns/elastic-and-transient-environments/images/5865670.png)
...
:::figure
![The Time unavailable setting changed to 5 minutes](/docs/img/deployments/patterns/elastic-and-transient-environments/images/5865677.png)
:::
...
2. Select the event "New deployment target becomes available".
   ...
   ![A trigger on the New deployment target becomes available event](/docs/img/deployments/patterns/elastic-and-transient-environments/images/5865666.png)
...
:::figure
![Hello World deployed automatically to newly provisioned Tentacles](/docs/img/deployments/patterns/elastic-and-transient-environments/images/5865678.png)
:::
