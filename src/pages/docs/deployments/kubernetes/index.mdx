...
Octopus Deploy makes it easy to manage your Kubernetes resources, whether you're starting simple or want complete control over a complex setup. This section has everything you need to know about using Octopus for Kubernetes CD.  You’ll find:
...
:::figure
![Kubernetes pipeline](/docs/deployments/kubernetes/pipeline-visual.png)
:::
...
You can also [create a configuration with our UI](https://octopus.com/docs/deployments/kubernetes/deploy-container), and Octopus will generate YAML behind the scenes for you.
