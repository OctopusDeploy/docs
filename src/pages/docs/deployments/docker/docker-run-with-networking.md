...
:::figure
![An Ubuntu deployment target tagged docker-server](/docs/img/deployments/docker/images/my-docker-host.png)
:::

1. Install and configure Docker Engine [on your Ubuntu machine](https://docs.docker.com/engine/install/ubuntu).
2. *Optionally*, configure a Docker Group and grant Octopus the ability to [manage the Docker Daemon as a non-root user](https://docs.docker.com/engine/install/linux-postinstall/#manage-docker-as-a-non-root-user).
...
![Adding a Docker Hub feed](/docs/img/deployments/docker/images/add-dockerhub-feed.png)
![A successful Docker Hub feed connection test](/docs/img/deployments/docker/images/test-dockerhub-feed.png)
...
![Package auto-complete returning busybox images from Docker Hub](/docs/img/deployments/docker/images/busybox-image-search.png)
...
1. Set *Network Alias* to **FirstServer**. This will make it easier to identify this specific container from another container in the network.
2. Skip down to the *Additional Arguments* section, and set the *Command* to be: `/bin/sh -c "ping localhost"`. This arbitrary script instructs the linux instance to ping itself forever, keeping the container alive for this demonstration.
...
1. Save the first container configuration and move on to creating the second container step.

:::figure
![The first container step configured](/docs/img/deployments/docker/images/add-first-server-step.png)
:::
...
![The PingCount project variable](/docs/img/deployments/docker/images/add-pingcount-variable.png)
...
:::figure
![The clean slate step that stops containers from previous deployments](/docs/img/deployments/docker/images/add-clean-slate-step.png)
:::
...
:::figure
![The step that writes container IP addresses to the log](/docs/img/deployments/docker/images/add-get-log-step.png)
:::
...
:::figure
![Creating a release of the Docker project](/docs/img/deployments/docker/images/docker-create-release.png)
:::
...
:::figure
![Task output from the clean slate step](/docs/img/deployments/docker/images/clean-slate-task-output.png)
:::
...
:::figure
![The package acquisition steps pulling images on the target](/docs/img/deployments/docker/images/acquire-package-steps.png)
:::
...
:::figure
![Task output from the first and second container steps](/docs/img/deployments/docker/images/first-and-second-server-task-output.png)
:::
...
:::figure
![Task output showing container IP addresses and ping results](/docs/img/deployments/docker/images/get-log-task-output.png)
:::
