...
:::figure
![A project's deployment progressing through the environments in its lifecycle](/docs/img/releases/lifecycles/images/lifecycle-deployment-process.png)
:::
...
By default, Octopus Deploy will include all environments in the default lifecycle, for example, Development &rarr; Test &rarr; Staging &rarr; Production.  That only works if all changes are made directly on the main or primary branch and there are no other branches.
