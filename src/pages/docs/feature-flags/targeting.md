...
![Screenshot of feature flag environment drawer, minimum version section is expanded, minimum version input has value 12.1.0](/docs/img/feature-flags/minimum-version.png)
...
![Screenshot of feature flag environment drawer, excluded tenants section expanded, tenants to exclude multi-select has Acme Corporation and Contoso Ltd tenants selected, tenant tags to exclude multi-select has Tier/Enterprise tag selected](/docs/img/feature-flags/excluded-tenants.png)
...
![Screenshot of feature flag environment drawer, included tenants section expanded, tenants to include multi-select has Acme Corporation selected, tenant rollout percentage and tenant tags to include in rollout inputs are empty](/docs/img/feature-flags/included-tenants.png)
...
![Screenshot of feature flag environment drawer, included tenants section expanded, tenants to include is empty, tenant rollout percentage is set to 50% and tenant tags to include in rollout multi-select has Tier/Free, Region/Australia, and Region/Europe selected](/docs/img/feature-flags/tenant-rollout.png)
...
![Screenshot of feature flag environment drawer, client rollout section expanded, client rollout percentage is set to 50% with 3 segments region/eu, region/au, and ring/early-adopter](/docs/img/feature-flags/segments.png)
...
![Screenshot of feature flag page showing rollout group selector expanded with new onboarding flow group selected](/docs/img/feature-flags/rollout-group-selector.png)
...
![Screenshot of feature flags list page with overflow menu expanded highlighting the manage rollout groups button](/docs/img/feature-flags/manage-rollout-group-overflow.png)

From the rollout groups page, you can add, rename, and delete rollout groups.

![Screenshot of rollout group list page with a single rollout group named new onboarding flow, used by the live chat and AI recommendations feature flags, with the overflow menu expanded and showing edit and delete options](/docs/img/feature-flags/rollout-group-page.png)
