...
- [Add library set to a project](/docs/octopus-rest-api/examples/variables/add-library-set-to-project)
...
- [Find projects using library set](/docs/octopus-rest-api/examples/variables/find-projects-using-library-set)
