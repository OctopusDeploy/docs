...
$ octopus project variable create --project "Deploy Website" --name varname --value "abc"
...
$ octopus project variable create --name varname --value "abc" --scope environment='test' --git-ref refs/heads/main
