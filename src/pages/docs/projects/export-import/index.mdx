...
- Cloning projects *within* a space. There is an [easier way to achieve this](/docs/projects/#clone-a-project).  
...
- Project variables (including sensitive values)
...
- The Tentacles are configured to trust the certificate of the new instance. This can be done using the Tentacle [configure](/docs/administration/tentacle.exe-command-line/configure) command.  
...
**Polling Tentacles** can be configured to poll multiple Octopus servers using the [register-with](/docs/administration/tentacle.exe-command-line/register-with) command.  
