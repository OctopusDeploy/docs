...
:::div{.warning}
Migrations can only be performed between equal versions of Octopus. This is due to underlying differences in the Octopus database between versions.

If you are a self-hosted customer attempting to migrate to Octopus Cloud using the Project Export/Import tool, please contact [Octopus Support](https://octopus.com/support) for more information.
:::
