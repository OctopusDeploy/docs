...
:::div{.info}
Support for version-controlled projects was added in Octopus **2025.2.x**
:::
...
- [Triggers](#triggers)
- [GitHub connection](#github-connection) used for a projects version-control settings
...
:::div{.warning}
Git credentials used on steps to source files from Git will not be exported.
:::

### GitHub Connection \{#github-connection}

:::div{.warning}
GitHub connection used by a version-controlled project will not be exported, due to that we can't re-configure GitHub connections on the destination side, because IDs and other detials are all instance-specific on the GitHub App side.
:::
