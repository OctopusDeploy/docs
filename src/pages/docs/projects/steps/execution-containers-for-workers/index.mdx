...
:::figure
![](/docs/projects/steps/execution-containers-for-workers/images/container-selector-giturl.png "width=500")
:::
...
The `Octopus.Action.Container.Options` variable can be [scoped](/docs/projects/variables#scoping-variables).
