...
:::figure
![Execution containers enabled on a hosted worker pool](/docs/img/projects/steps/execution-containers-for-workers/images/hosted-worker-pools-execution-containers.png)
:::
...
:::figure
![Selecting a container image for a step](/docs/img/projects/steps/execution-containers-for-workers/images/container-selector-image.png)
:::
...
The operating system must also include a number of dependencies required to support .NET Core applications. When a step is configured to use an execution container, [Calamari](/docs/administration/calamari) (the Octopus deployment utility) is executed inside the specified container. Since Calamari is a .NET Core self-contained executable, any custom Docker image needs to include the dependencies required to execute a .NET self-contained executable.
...
:::figure
![The Docker image from a Git URL option](/docs/img/projects/steps/execution-containers-for-workers/images/container-selector-git-url.png)
:::
...
:::figure
![The Docker image from an inline Dockerfile option](/docs/img/projects/steps/execution-containers-for-workers/images/container-selector-docker-file.png)
:::
