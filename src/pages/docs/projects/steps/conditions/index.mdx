...
When a step fails the server will wait for a "backoff interval" to pass before trying again. By default, the backoff interval is 15 seconds, however this value can be adjusted as required.
