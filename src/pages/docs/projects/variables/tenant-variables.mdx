...
![The project templates screen showing tenant variable values per environment](/docs/img/tenants/images/project-template-screen.png)
...
![Editing tenant variable values for each tenant and environment](/docs/img/projects/variables/images/tenant-variables-edit.png)
...
3. Add the details to your template and click **ADD**:
    ...
    ![Adding a variable template to a project](/docs/img/projects/variables/images/variable-templates-project-template.png)
...
1. Expand each connected environment and provide values for each project template:
    ...
    ![Providing project template values for each connected environment](/docs/img/projects/variables/images/variable-templates-project-value.png)
...
:::figure
![Adding a variable template to a library variable set](/docs/img/projects/variables/images/variable-templates-library-set.png)
:::
...
2. Provide values for each common template.
    ...
    ![Providing values for each common variable template](/docs/img/projects/variables/images/variable-templates-common-value.png)
