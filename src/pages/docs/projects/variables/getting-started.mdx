...
:::figure
![Adding a project variable](/docs/projects/variables/images/add-project-variable.png)
:::
...
:::figure
![Adding a project variable](/docs/projects/variables/images/hello-world-greeting-script.png)
:::
