...
Variable templates let you specify which [variables](/docs/projects/variables/index/) are required to successfully deploy a project to a [tenant](/docs/tenants/), and to provide those variables per tenant. 
