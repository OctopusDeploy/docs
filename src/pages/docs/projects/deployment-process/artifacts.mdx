...
:::figure
![The Task Summary tab of a deployment, showing collected artifacts listed under each step and in the Artifacts panel](/docs/img/projects/deployment-process/images/artifacts-access.png)
:::
