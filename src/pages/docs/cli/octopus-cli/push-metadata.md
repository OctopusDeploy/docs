...
This command has been deprecated. Please use the [build-information](/docs/cli/octopus-cli/build-information) command for Octopus Server 2019.10.0 and above.
