...
The [Octopus CLI](/docs/cli/octopus-cli) can be used to automate the creation of releases using the **`create-release`** command. This allows you to easily integrate Octopus with other continuous integration servers.
...
- [Octopus CLI](/docs/cli/octopus-cli)
