...
:::figure
![A screenshot of Octopus Deploy's Recovery Agent showing suggestions on how to fix a deployment failure](/public/docs/img/octopus-ai-assistant/recovery-agent.gif)
:::
