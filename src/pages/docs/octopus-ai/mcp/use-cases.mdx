...
```
 Check accounts configured in {SpaceName} space in my Octopus instance, find the preprod azure account and then check which resources are available in that subscription using the azure mcp
```