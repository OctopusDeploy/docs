...
The deployment process and many other parts of a project can be stored in a Git repository. Learn more about [version control](/docs/projects/version-control).
