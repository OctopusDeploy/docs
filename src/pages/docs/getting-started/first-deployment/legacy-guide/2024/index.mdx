...
* **Octopus 2024.3** or newer [First deployment guide](/docs/getting-started/first-deployment/index)
:::
...
:::figure
![GET STARTED](/docs/getting-started/first-deployment/legacy-guide/images/img-getstarted.png "width=500")
:::
...
:::figure
![Add project](/docs/getting-started/first-deployment/legacy-guide/images/img-addprojectdialog.png "width=500")
:::
...
![Add Environments](/docs/getting-started/first-deployment/legacy-guide/images/img-createenvironmentdialog.png "width=500")
...
:::figure
![Project questionnaire](/docs/getting-started/first-deployment/legacy-guide/images/img-questionnairedialog.png "width=500")
:::
...
:::figure
![Create deployment process](/docs/getting-started/first-deployment/legacy-guide/images/img-createdeploymentprocess.png "width=500")
:::
...
:::figure
![Release and deploy](/docs/getting-started/first-deployment/legacy-guide/images/img-createrelease.png "width=500")
:::
...
:::figure
![First deployment](/docs/getting-started/first-deployment/legacy-guide/images/img-successfulrelease.png "width=500")
:::
