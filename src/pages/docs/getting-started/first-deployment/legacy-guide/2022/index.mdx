...
* For **Octopus 2024.3** or newer, please visit this [First deployment guide](/docs/getting-started/first-deployment/index).
* For **Octopus 2022.2** or earlier, please visit this legacy [First deployment guide](/docs/getting-started/first-deployment/legacy-guide/2024)
:::
