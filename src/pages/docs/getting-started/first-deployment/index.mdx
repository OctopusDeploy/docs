...
2. In the **Featured** category, locate the Run a Script card and click **Add Step**.
    ...
    **Step Name:** You can leave this as the default *Run a Script*.

    **Script Source:** You can source script files via 3 methods:
...
6. **Worker Pool:** If you're using Octopus Cloud, keep the default **Runs on a worker from a specific worker pool** option selected.
