...
* **Octopus 2022.2** or earlier [First deployment guide](/docs/getting-started/first-deployment/legacy-guide/2022/index)
* **Octopus 2024.2** or earlier [First deployment guide](/docs/getting-started/first-deployment/legacy-guide/2024/index)
:::
...
8. Keep the default **Runs on a worker from a specific worker pool** option selected.
