...
* **Octopus 2022.2** or earlier legacy [First deployment guide](/docs/getting-started/first-deployment/legacy-guide/2024)
* **Octopus 2024.2** or earlier legacy [First deployment guide](/docs/getting-started/first-deployment/legacy-guide/2024)
:::
...
:::figure
![Environment selection options and deployment lifecycle visuals](/docs/getting-started/first-deployment/images/get-started.png)
:::
...
:::figure
![Inline source code expander where users type a script](/docs/getting-started/first-deployment/images/inline-source-code.png)
:::
...
:::figure
![Img description](/docs/getting-started/first-deployment/images/worker-pool.png)
:::
...
:::figure
![First deployment](/docs/getting-started/first-deployment/images/successful-deployment.png)
:::
