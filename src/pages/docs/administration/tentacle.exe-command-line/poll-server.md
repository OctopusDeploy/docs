...
:::div{.warning}
A running Tentacle doesn't pick up this change. Restart the Tentacle service with the [service](/docs/administration/tentacle.exe-command-line/service) command after you run `poll-server`, or the Tentacle won't connect to the server you just added.
:::
