...
1. Will the new instance's domain name be the same or will it change?  For example, will it change from [https://octopusdeploy.mydomain.com](https://octopusdeploy.mydomain.com) to [https://octopus.mydomain.com](https://octopus.mydomain.com).  If it changes and you are using polling Tentacles, you will need to create new Tentacle instances for the new Octopus Deploy instance.
...
A polling Tentacle can only connect to one Octopus Deploy instance.  It connects via DNS name or IP address.  If the new instance's DNS name changes - for example, the old instance was [https://octopusdeploy.mydomain.com](https://octopusdeploy.mydomain.com) with the new instance set to [https://octopus.mydomain.com](https://octopus.mydomain.com) - you'll need to clone each polling Tentacle instance.
