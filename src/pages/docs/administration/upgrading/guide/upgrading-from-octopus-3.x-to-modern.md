...
Read more about the [Octopus - Tentacle communication](/docs/security/octopus-Tentacle-communication/) protocol and [Troubleshooting Schannel and TLS](/docs/security/octopus-Tentacle-communication/troubleshooting-schannel-and-tls.md).
:::
