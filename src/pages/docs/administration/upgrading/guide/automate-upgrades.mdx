...
:::figure
![Diagram of a runbook on a separate instance upgrading a High Availability instance](/docs/img/administration/upgrading/guide/images/upgrade-diagram.png)
:::
...
:::figure
![The automated upgrade runbook process broken into steps](/docs/img/administration/upgrading/guide/images/automated-upgrade-runbook-process.png)
:::
...
![A step run condition set on the Upgrade.Octopus.HasNewVersion variable](/docs/img/administration/upgrading/guide/images/automate-upgrade-variable-run-condition.png)
:::
