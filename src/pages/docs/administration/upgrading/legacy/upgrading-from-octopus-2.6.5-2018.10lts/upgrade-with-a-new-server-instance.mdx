...
:::figure
![The Check Health option on the Environments page](/docs/img/administration/upgrading/legacy/upgrading-from-octopus-2.6.5-2018.10lts/images/3278012.png)
:::

After successfully updating your Tentacles, you should see this check fail from your **Octopus 2.6.5** server.

:::figure
![A failed health check on the Octopus 2.6.5 server](/docs/img/administration/upgrading/legacy/upgrading-from-octopus-2.6.5-2018.10lts/images/3278011.png)
:::

Performing the Check Health on your **Octopus 2018.10 LTS** server should now succeed.

:::figure
![A successful health check on the Octopus 2018.10 LTS server](/docs/img/administration/upgrading/legacy/upgrading-from-octopus-2.6.5-2018.10lts/images/3278009.png)
:::
