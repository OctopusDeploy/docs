...
:::figure
![The Delete option in a node's overflow menu on the Nodes screen](/docs/img/administration/high-availability/troubleshooting/images/deleting-nodes.png)
:::
...
4. Reconfigure your Octopus HA cluster to use the shared storage.
5. Copy all files into the shared storage location - there shouldn't be any filename collisions since each node will generally run independent tasks.
6. Bring your Octopus HA cluster back online.
