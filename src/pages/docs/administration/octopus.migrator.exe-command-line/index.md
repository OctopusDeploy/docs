...
- **[export](/docs/administration/octopus.migrator.exe-command-line/export)**:  Exports all configuration data to a directory.
- **[import](/docs/administration/octopus.migrator.exe-command-line/import)**:  Imports data from an Octopus 3.0+ export directory.
- **[migrate](/docs/administration/octopus.migrator.exe-command-line/migrate)**:  Imports data from an Octopus 2.6 backup.
- **[partial-export](/docs/administration/octopus.migrator.exe-command-line/partial-export)**:  Exports configuration data to a directory filtered by projects.
- **[version](/docs/administration/octopus.migrator.exe-command-line/version)**:  Shows the version information for this release of the Octopus Migrator.
