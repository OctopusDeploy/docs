...
When connecting to an existing database, you will be prompted for this key during the setup process. If you have already set up the server, you can [change the Master Key](/docs/administration/octopus.server.exe-command-line/database) to work with the restored database.
