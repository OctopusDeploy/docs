...
:::figure
![The Lifecycles page under Deploy ➜ Manage](/docs/img/administration/retention-policies/images/lifecycles.png)
:::
...
:::figure
![The Retention Policy panel expanded on a lifecycle phase](/docs/img/administration/retention-policies/images/lifecycle-retention-policy.png)
:::
...
:::figure
![The default release retention settings for a space](/docs/img/administration/retention-policies/images/centralized-retention-lifecycle.png)
:::
