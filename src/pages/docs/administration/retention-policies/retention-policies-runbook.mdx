...
:::figure
![The retention policy settings for a runbook](/docs/img/administration/retention-policies/images/runbook-retention-policy.png)
:::
...
:::figure
![The default runbook retention settings for a space](/docs/img/administration/retention-policies/images/centralized-retention-runbook.png)
:::
