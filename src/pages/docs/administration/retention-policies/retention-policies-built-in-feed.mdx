...
:::figure
![The built-in repository retention policy settings](/docs/img/administration/retention-policies/images/built-in-feed-retention-policy.png)
:::
...
:::figure
![Choosing how long to keep packages in the built-in repository](/docs/img/administration/retention-policies/images/built-in-repository.png)
:::
...
:::figure
![The option to delete packages associated with releases in the built-in repository retention settings](/docs/img/administration/retention-policies/images/built-in-repository-decoupled.png)
:::
