...
<span id="table-note-3">**†**</span> For Okta groups to flow through to Octopus, you'll need to change the *Groups claim* fields. Please read the [Okta group integration](/docs/security/authentication/okta-authentication/#okta-groups) section for more details.
