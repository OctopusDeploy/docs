...
:::figure
![The sign in page offering a guest sign in option](/docs/img/security/authentication/images/guest.png)
:::
...
![The Guest Login settings under Configuration ➜ Settings](/docs/img/security/authentication/images/enableguests1.png)
![The Is Enabled checkbox for guest login](/docs/img/security/authentication/images/enableguests2.png)
...
:::figure
![The guest user in the list of Octopus users](/docs/img/security/authentication/images/guestuser.png)
:::
...
![The guest user assigned to a team](/docs/img/security/authentication/images/guestuserpermissions.png)
:::
