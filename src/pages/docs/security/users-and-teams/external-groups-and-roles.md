...
:::figure
![The member buttons available on the Team page](/docs/img/security/users-and-teams/images/members-buttons.png)
:::
...
:::figure
![The dialog for adding an Active Directory group](/docs/img/security/users-and-teams/images/add-ad-group.png)
:::
...
:::figure
![Searching for a group in a trusted domain](/docs/img/security/users-and-teams/images/add-ad-group-trusted-domains.png)
:::
...
:::figure
![The dialog for adding an external role](/docs/img/security/users-and-teams/images/add-external-role.png)
:::
