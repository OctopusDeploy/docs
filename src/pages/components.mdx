...
<div class="docs-home simple-grid">
  <div>
    <div class="btn-row">
      <SplitButton
        ...
        items={[
          { label: 'Open in Claude', href: '#split-button-example' },
          { label: 'Open in ChatGPT', href: '#split-button-example' },
        ]}
      />
    </div>
    <div class="btn-row">
      <SplitButton
        ...
        items={[
          { label: 'First action', href: '#split-button-example' },
          { label: 'Second action', href: '#split-button-example' },
        ]}
      />
    </div>
  </div>
  <div>
    ...
    <SplitButton
      ...
      menuLabel="Open in another assistant"
      items={[
        { label: 'Open in Claude', href: '/some/url' },
        { label: 'Open in ChatGPT', href: '/another/url' },
      ]}
    />
    ```
  </div>
