...
<div class="docs-home simple-grid">
  <div>
    <div class="btn-row">
      ...
      <Button label="Label" icon="fa-solid fa-copy" iconEnd="fa-solid fa-caret-down" />
    ...
    <div class="btn-row">
      ...
      <Button label="Label" icon="fa-solid fa-copy" iconEnd="fa-solid fa-caret-down" size="small" />
    ...
    <div class="btn-row">
      ...
      <Button label="Label" icon="fa-solid fa-copy" iconEnd="fa-solid fa-caret-down" size="xSmall" />
...
<div class="docs-home simple-grid">
  <div class="btn-row">
    <Button label="Label" icon="fa-solid fa-copy" iconEnd="fa-solid fa-caret-down" disabled={true} />
...
// leftover space and everything except the nav is held back at the 800px the column normally maxes out at
}
<style>{`
