...
import linkIcon from 'src/assets/icons/link-on.svg';
...
<div class="docs-home simple-grid">
  <div class="btn-row">
    <SplitButton
      ...
      items={[
        { label: 'Open in Claude', href: '#split-button-example', iconEnd: externalLinkIcon.src },
        { label: 'Open in ChatGPT', href: '#split-button-example', iconEnd: externalLinkIcon.src },
      ]}
    />
    <SplitButton
      label="Copy"
      ...
      items={[
        { label: 'Copy page', href: '#split-button-example', icon: copyIcon.src },
        { label: 'Copy link', href: '#split-button-example', icon: linkIcon.src },
      ]}
    />
  </div>
  <div>
    ...
    <SplitButton
      ...
      menuLabel="Open in another assistant"
      items={[
        { label: 'Open in Claude', href: '/some/url', iconEnd: externalLinkIcon.src },
        { label: 'Open in ChatGPT', href: '/another/url', iconEnd: externalLinkIcon.src },
      ]}
    />
    ```
  </div>
