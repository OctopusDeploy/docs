...
description: Creates a [Amazon Cloud Formation Stack](#http://docs.aws.amazon.com/powershell/latest/reference/items/New-CFNStack.html) with the template specified.  - Requires the [AWS PowerShell cmdlets](http://aws.amazon.com/powershell/)
navMenu: false
