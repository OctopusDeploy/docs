...
description: >-
    Uses Redgate's [SQL Change Automation](http://www.red-gate.com/sca/productpage) to deploy a source schema to a SQL Server database without a review step.  Requires SQL Change Automation version 3.0.2 or later.  *Version date: 2020-12-21*
navMenu: false
