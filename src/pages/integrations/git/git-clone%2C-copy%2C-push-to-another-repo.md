...
### Source Git User Password

`Template.Git.Source.User.Password = `
...
`Template.Git.Source.Path = `

Relative path to the folder or items to copy.  This field can take wildcards, eg - `/MyPath/*`
...
**(Optional)** Checkout the code for `SourcePath` from a specific tag.
...
`Template.Git.Destination.Repo.Url = `

The destination repository to copy and push files to.

</div>
        
<div class="param">

### Destination Git Username

`Template.Git.Destination.User.Name = `

Username of the credentials to log into destination git repo.

</div>
        
<div class="param">

### Destination Git User Password

`Template.Git.Destination.User.Password = `

Password for the destination git credential.
...
[Report an issue](https://github.com/OctopusDeploy/Library/issues/new?assignees=&labels=&projects=&template=bug-report.yml&title=Issue%20with%20Git%20-%20Clone%2C%20copy%2C%20push%20to%20another%20repo&step-template=Git%20-%20Clone%2C%20copy%2C%20push%20to%20another%20repo)
...
```json
{
  ...
  "Category": "Git",
  "HistoryUrl": "https://github.com/OctopusDeploy/Library/commits/master/step-templates//opt/buildagent/work/75443764cd38076d/step-templates/git-clone-copy-push-another-repo.json",
  "Website": "/step-templates/6db15b08-f6c6-4a6e-833c-773eb38ec0f0",
...
[History](https://github.com/OctopusDeploy/Library/commits/master/step-templates/https://github.com/OctopusDeploy/Library/commits/master/step-templates//opt/buildagent/work/75443764cd38076d/step-templates/git-clone-copy-push-another-repo.json)
