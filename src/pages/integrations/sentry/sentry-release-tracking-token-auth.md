...
description: Posts a new release to Sentry and links it to one or more sentry projects.   **Updated version** which uses the newer **API Token** instead of the now depreciated API Key which is only available in legacy Sentry accounts.
navMenu: false
