...
The project channel to use when finding or [creating](https://octopus.com/docs/releases/channels#Channels-CreatingReleases) the release to deploy
...
_Leave blank to perform an untenanted deployment_
...
Provide values for [prompted variables](https://octopus.com/docs/projects/variables/prompted-variables) to use in the deployment
...
Determines how deployment failures & [guided failure mode](https://octopus.com/docs/releases/guided-failures) should be handled for the deployment
...
[Report an issue](https://github.com/OctopusDeploy/Library/issues/new?assignees=&labels=&projects=&template=bug-report.yml&title=Issue%20with%20Chain%20Deployment&step-template=Chain%20Deployment)
...
[History](https://github.com/OctopusDeploy/Library/commits/master/step-templates/https://github.com/OctopusDeploy/Library/commits/master/step-templates//opt/buildagent/work/75443764cd38076d/step-templates/octopus-chain-deployment.json)
