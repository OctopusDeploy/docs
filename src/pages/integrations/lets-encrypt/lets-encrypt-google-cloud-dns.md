...
pubDate: 2021-08-23
title: 'Lets Encrypt - Google Cloud DNS'
description: >-
...
`LE_GCloudDNS_CertificateDomain = `
...
`LE_GCloudDNS_ReplaceIfExpiresInDays = 30`
...
### Google Cloud IAM Json

`LE_GCloudDNS_JSON = `

Google Cloud IAM JSON with the [appropriate permissions](https://github.com/rmbolger/Posh-ACME/blob/master/Posh-ACME/DnsPlugins/GCloud-Readme.md).
...
`LE_GCloudDNS_Use_Staging = false`
...
`LE_GCloudDNS_ContactEmailAddress = #{Octopus.Deployment.CreatedBy.EmailAddress}`
...
`LE_GCloudDNS_CreateWildcardSAN = false`
...
[Report an issue](https://github.com/OctopusDeploy/Library/issues/new?assignees=&labels=&projects=&template=bug-report.yml&title=Issue%20with%20Lets%20Encrypt%20-%20Google%20Cloud%20DNS&step-template=Lets%20Encrypt%20-%20Google%20Cloud%20DNS)
...
```json
{
  ...
  "HistoryUrl": "https://github.com/OctopusDeploy/Library/commits/master/step-templates//opt/buildagent/work/75443764cd38076d/step-templates/letsencrypt-google-cloud.json",
  "Website": "/step-templates/0ea316b3-562e-4782-8611-ce82f5224eff",
...
[History](https://github.com/OctopusDeploy/Library/commits/master/step-templates/https://github.com/OctopusDeploy/Library/commits/master/step-templates//opt/buildagent/work/75443764cd38076d/step-templates/letsencrypt-google-cloud.json)
