...
description: Exports a database to a bacpac  *Depends on az cli*  *Source database requires 'Allow Azure services and resources to access this server' option turn on in the SQL server firewall*
navMenu: false
